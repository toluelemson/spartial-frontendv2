...
// //     // setBuildStatusStatex: (value: (((prevState: (BuildStatusType | null)) => (BuildStatusType | null)) | BuildStatusType | null)) => void;
// //     // updateBuildStatus: () => () => void;
// //     // buildStatusStatex: BuildStatusType | null
// // }] => {
...
//     //
//     // return [{
//     //     "buildStatusStatex": buildStatusState,
//     //     "setBuildStatusStatex": setBuildStatusState,
