...
const SpatialDashboard: React.FC = () => {
    ...
    const getFirstTwoCharsOfModelId = (params: string): string => params.length >= 2 ? params.substring(0, 2) : '';
                ...
                <>
                    <Tabs>
                        <Tab eventKey="subtab6" title={"NetworkTrafficTab"}>
                            <NetworkTrafficTab
                                filtteredModels={filteredModels} comparisonState={comparisonState}
                        ...
                        <Tab eventKey="subtab8" title="Compare">
                            <ComparisonTab filteredModels={filteredModels}
