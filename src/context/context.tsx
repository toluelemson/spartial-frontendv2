...
interface SpatialContextType {
    ...
    setAllMedicalModels: React.Dispatch<React.SetStateAction<ModelListType | null>>;
...
export const Provider: React.FC<ProviderProps> = ({children}) => {
    ...
    const [allMedicalModels, setAllMedicalModels] = useState<ModelListType | null>(
        initialModelList
    );
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            try {
                ...
                const medicalModels = allMedicalModelsResponse as unknown as MedicalModel[];
                const mappedMedicalModels = medicalModels.map(mapMedicalModelToModelData);
